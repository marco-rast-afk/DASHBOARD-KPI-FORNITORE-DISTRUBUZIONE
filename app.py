...
with tab1:
    ...
    if riepilogo:
        ...
        fig_prod.update_layout(**LAYOUT_DARK, height=300, xaxis={**AX}, yaxis={**AX, "title": "Media Giornaliera Pezzi per Corriere"})
        ...
        fig_lv.update_layout(**LAYOUT_DARK, barmode="group", height=300, xaxis={**AX}, yaxis={**AX})
...
with tab2:
    ...
    if agg:
        ...
        if not df_giorni.empty:
            ...
            fig_trend.update_layout(**LAYOUT_DARK, height=280, xaxis={**AX}, yaxis={**AX})
        ...
        if per_giro:
            ...
            fig_giri.update_layout(**LAYOUT_DARK, height=max(250, len(giri_sorted) * 28), xaxis={**AX, "title": "LDV OK+RIT medi/giorno"}, yaxis={**AX, "autorange": "reversed"}, margin=dict(l=0, r=60, t=20, b=0))
...
with tab3:
    ...
    if righe_tutti:
        ...
        if not df_tutti_f.empty and len(fil_filter) > 0:
            ...
            fig_conf.update_layout(**LAYOUT_DARK, barmode="group", height=320, xaxis={**AX, "title": "Giro"}, yaxis={**AX, "title": "LDV OK+RIT medi/giorno"})
...
with tab4:
    ...
    if giornate_g:
        ...
        fig_day.update_layout(**LAYOUT_DARK, barmode="stack", height=max(250, len(righe_giorno) * 30), yaxis={**AX, "autorange": "reversed"}, xaxis={**AX}, margin=dict(l=0, r=0, t=20, b=0))
...
with tab5:
    ...
    if giornate_t:
        ...
        fig_tar.update_layout(**LAYOUT_DARK, height=300, xaxis={**AX}, yaxis={**AX, "tickprefix": "€ "}, margin=dict(l=0, r=0, t=30, b=0))
        ...
        fig_vol.update_layout(**LAYOUT_DARK, height=260, xaxis={**AX}, yaxis={**AX, "title": "LDV"}, margin=dict(l=0, r=0, t=20, b=0))
